...
{---------------------- Implication -----------------------------------------}
  ...
  cong-→ᵒ : ∀{Γ}{Δ}{ϕ ϕ′ ψ ψ′ : Setᵒ Γ Δ} → ϕ ≡ᵒ ϕ′ → ψ ≡ᵒ ψ′ → ϕ →ᵒ ψ ≡ᵒ ϕ′ →ᵒ ψ′
  cong-→ᵒ {Γ}{Δ}{ϕ}{ϕ′}{ψ}{ψ′} ϕ=ϕ′ ψ=ψ′ = ⇔⇒≡ᵒ (λ δ k → ⇔-intro to from)
    where
    to : ∀{δ}{k} → (# ϕ δ →ₒ # ψ δ) k → (# ϕ′ δ →ₒ # ψ′ δ) k
    to ϕ→ψ = λ j j≤k ϕ′j →
         let ψj = ϕ→ψ j j≤k (⇔-fro (≡ᵒ⇒⇔ ϕ=ϕ′) ϕ′j) in  (⇔-to (≡ᵒ⇒⇔ ψ=ψ′) ψj)
    from : ∀{δ}{k} → (# ϕ′ δ →ₒ # ψ′ δ) k → (# ϕ δ →ₒ # ψ δ) k
    from ϕ′→ψ′ = λ j j≤k ϕj →
         let ψ′j = ϕ′→ψ′ j j≤k ((⇔-to (≡ᵒ⇒⇔ ϕ=ϕ′) ϕj)) in (⇔-fro (≡ᵒ⇒⇔ ψ=ψ′) ψ′j)
